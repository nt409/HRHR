...
def solv_ode(t,y):
    ...
    dydt = [growth(A,t) - (Senescence(t))*S -  S * (PARAMS.beta/A) * (  
        ...
        S*(PARAMS.beta/A) * (fngcide(PARAMS.alpha_1*PARAMS.omega_1,PARAMS.alpha_1_C*PARAMS.theta_1,Fung1)) * (fngcide(PARAMS.alpha_2*PARAMS.omega_2,PARAMS.alpha_2_C*PARAMS.theta_2,Fung2)) * (IR + PR)   - (Senescence(t)) * ER  - PARAMS.gamma * (fngcide(PARAMS.alpha_1*PARAMS.omega_1_L,PARAMS.alpha_1_C*PARAMS.theta_1_L,Fung1))*(fngcide(PARAMS.alpha_2*PARAMS.omega_2_L,PARAMS.alpha_2_C*PARAMS.theta_2_L,Fung2)) * ER,
        S*(PARAMS.beta/A) * (fngcide(PARAMS.alpha_1*PARAMS.omega_1,PARAMS.alpha_1_C*PARAMS.theta_1,Fung1)) * (fngcide(                  PARAMS.omega_2,                    PARAMS.theta_2,Fung2)) * (IRS + PRS) - (Senescence(t)) * ERS - PARAMS.gamma * (fngcide(PARAMS.alpha_1*PARAMS.omega_1_L,PARAMS.alpha_1_C*PARAMS.theta_1_L,Fung1))*(fngcide(                  PARAMS.omega_2_L,                    PARAMS.theta_2_L,Fung2)) * ERS,
        S*(PARAMS.beta/A) * (fngcide(                  PARAMS.omega_1,                    PARAMS.theta_1,Fung1)) * (fngcide(PARAMS.alpha_2*PARAMS.omega_2,PARAMS.alpha_2_C*PARAMS.theta_2,Fung2)) * (ISR + PSR) - (Senescence(t)) * ESR - PARAMS.gamma * (fngcide(                  PARAMS.omega_1_L,                    PARAMS.theta_1_L,Fung1))*(fngcide(PARAMS.alpha_2*PARAMS.omega_2_L,PARAMS.alpha_2_C*PARAMS.theta_2_L,Fung2)) * ESR,
        S*(PARAMS.beta/A) * (fngcide(                  PARAMS.omega_1,                    PARAMS.theta_1,Fung1)) * (fngcide(                  PARAMS.omega_2,                    PARAMS.theta_2,Fung2)) * (IS + PS)   - (Senescence(t)) * ES  - PARAMS.gamma * (fngcide(                  PARAMS.omega_1_L,                    PARAMS.theta_1_L,Fung1))*(fngcide(                  PARAMS.omega_2_L,                    PARAMS.theta_2_L,Fung2)) * ES,
        ...
        PARAMS.mu * (IR + IRS + ISR + IS)   +  (Senescence(t)) * (S + ER + ERS + ESR + ES),
