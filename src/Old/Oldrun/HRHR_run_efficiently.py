...
##
from utils.plotter_HRHR import Overlay_plotter, plot_disease_dynamics, bar_plotter, line_or_scatter_plotter # Equal_dose,
from utils.functions_HRHR import interpolate, solv_ode, master_loop_one_tactic, master_loop_grid_of_tactics, Z_metric, Dose_tuplet_extractor, fngcide
...
i_vector = [0.25,0.5,0.75,1]
j_vector = [0.25,0.5,0.75,1]
### for dynamics_by_SR_RF
r_vec = [10**(-6),10**(-3),0.01,0.02,0.04,0.07]
n_here= len(r_vec)
n_d = 20
